class plexmediaserver::params {
  ...
  case $::operatingsystem {
    'Darwin': {
      $plex_url      = 'https://downloads.plex.tv/plex-media-server/0.9.16.3.1840-cece46d'
      $plex_pkg      = 'PlexMediaServer-0.9.16.3.1840-cece46d-OSX.zip'
      $plex_provider = 'pkgdmg'
    }
    'Ubuntu': {
      $plex_url         = 'https://downloads.plex.tv/plex-media-server/0.9.16.3.1840-cece46d'
      $plex_pkg         = "plexmediaserver_0.9.16.3.1840-cece46d_${::architecture}.deb"
      $plex_provider    = 'dpkg'
    ...
    'Fedora': {
      $plex_url      = 'https://downloads.plex.tv/plex-media-server/0.9.16.3.1840-cece46d'
      $plex_pkg      = "plexmediaserver-0.9.16.3.1840-cece46d.${::architecture}.rpm"
      $plex_provider = 'rpm'
